...
* 翻訳対象の元ネタであるラグナロクオンライン(の日本語版)における名称にある程度準拠して翻訳しています
  * 例: `Arrow Repel` → `チャージアロー`
  * 例: `Double Strafe` → `ダブルストレイフィング`
* パッシブ(取得するだけで効果がある)サイキックについては、名称の頭に `(P)` を付けています
  * 例: `Passive: Double Attack` → `(P)ダブルアタック`
